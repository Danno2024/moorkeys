            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                <div class="lg:col-span-3 space-y-5">
                    ...
                    <div class="flex items-center gap-3">
                        <input type="checkbox" name="is_active" id="is_active" value="1" @checked(old('is_active', $emailTemplate->is_active)) class="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
