...
<div class="bg-white rounded-xl shadow-sm border border-gray-200">
    <div class="p-6 border-b border-gray-200">
        <h2 class="text-xl font-bold text-gray-900">Create Email Template</h2>
        <p class="text-gray-600 mt-1">Define reusable email templates with Blade-style variables like <code class="bg-gray-100 px-1.5 py-0.5 rounded text-sm">@{{variable_name}}</code></p>
    </div>
    <div class="p-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                <div class="lg:col-span-3 space-y-5">
                    <div>
                        ...
                        <input type="text" name="key" value="{{ old('key') }}" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" placeholder="e.g. welcome_email" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" placeholder="Welcome Email" required>
                        @error('name') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Subject <span class="text-red-500">*</span></label>
                        <input type="text" name="subject" value="{{ old('subject') }}" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" placeholder="Welcome to @{{app_name}}!" required>
                    ...
                    <div>
                        ...
                        <input type="text" name="variables" value="{{ old('variables') }}" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" placeholder="name, email, app_name, login_url">
                    ...
                    <div>
                        ...
                        <textarea name="body" rows="20" class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 font-mono text-sm" required placeholder="<html>
<body>
    <h1>Welcome @{{name}}!</h1>
