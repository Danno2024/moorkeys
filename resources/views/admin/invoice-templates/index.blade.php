...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="{{ route('admin.invoice-templates.create') }}" class="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 text-sm font-medium">Add Template</a>
</div>
        ...
        <table class="w-full text-sm">
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4">{!! $template->is_default ? '<span class="text-green-600 font-bold">&check;</span>' : '<span class="text-gray-300">&mdash;</span>' !!}</td>
