...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="<?php echo e(route('admin.email-templates.create')); ?>" class="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 text-sm font-medium">Add Template</a>
</div>
        ...
        <table class="w-full text-sm">
            ...
            <tbody>
                ...
                <tr class="border-b border-gray-100 hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 text-gray-600"><code class="text-xs bg-gray-100 px-2 py-1 rounded"><?php echo e($template->key); ?></code></td>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\dev\htdocs\moorkeys\resources\views/admin/email-templates/index.blade.php ENDPATH**/ ?>